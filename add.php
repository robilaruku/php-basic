<?php
    ...
    if(!empty($submit)) {
        ...
        validate($no_hp, "No HP tidak boleh kosong", $errors);
        validate($gender, "Gender tidak boleh kosong", $errors);
        ...
        if(empty($errors)) {
            ...
            $sql = "INSERT INTO student VALUES(NULL, '{$nama_depan}', '{$nama_belakang}', 
                '{$no_hp}', '{$gender}', '{$jenjang}', '{$hobi}', '{$alamat}')"; 
        }
    }
